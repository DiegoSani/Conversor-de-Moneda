...
public class CurrencyConverter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Utilizamos un bucle while para permitir múltiples consultas
        while (true) {
            ...
            sc.nextLine(); // Consumir el carácter de nueva línea en el búfer

            sendHttpGetRequest(fromCode, toCode, amount, API_KEY);

            System.out.println("Do you want to make another conversion? (yes/no)");
            String continueChoice = sc.next();
            if (!continueChoice.equalsIgnoreCase("yes")) {
                break; // Si el usuario no quiere continuar, salimos del bucle
            }
        }
